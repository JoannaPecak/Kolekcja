...
public class PrzypinkiController {
    ...
    public String view(@PathVariable("id") Long id, final ModelMap model) {
        ...
        if (result.isPresent()) {
            ...
            notifyService.addErrorMessage("" + id);
            model.clear();
    ...
    public String saveMoneta(Przypinka moneta, BindingResult bindingResult, ModelMap model) {
    ...
    public String createMoneta(Przypinka moneta, BindingResult bindingResult, ModelMap model) {
        if (bindingResult.hasErrors()) {
            notifyService.addErrorMessage("!");
            model.addAttribute("MyMessages",  notifyService.getNotificationMessages());
            return "th/przypinka";
    ...
    public String removeRow(final Przypinka moneta, final BindingResult bindingResult, final HttpServletRequest req, @RequestParam Integer remove) {
//        final Integer rowId = Integer.valueOf(req.getParameter("remove"));
    ...
    public String showMainPages(final Przypinka przypinka) {
    	...
    	przypinka.setData(Calendar.getInstance().getTime());
        return "th/przypinka";
    }
}